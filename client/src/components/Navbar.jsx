    ...
    <div>
      <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
        <div className="flex lg:flex-1 flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24]  rounded-[100px]">
          <input
            type="text"
            placeholder="Search for campagins"
            className="flex w-full font-epilogue font-normal text-[14px] placeholder:text-[#4b52564] text-white bg-transparent outline-none
          "
          ></input>
        ...
        {/*  Small Screen Navbar*/}
        <div className="sm:hidden flex justify-between items-center realtive">
